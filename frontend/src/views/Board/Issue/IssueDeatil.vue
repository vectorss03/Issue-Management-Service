        ...
        <div class="flex border rounded">
          ...
          <ol class="mx-16 items-center my-3 py-1">
            <li class="text-sm mb-3">
              ...
              <button class="mx-2.5 text-blue-700 text-xs px-4 hover:underline">Change State</button>
            </li>
            ...
            <li class="text-sm mb-3">
              ...
              <div id="assign-developer-modal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
